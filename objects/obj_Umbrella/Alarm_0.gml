...
umbId[|0] = instance_position(x,y-55,obj_Umbrella);
umbId[|1] = instance_position(x,y+55,obj_Umbrella);
umbId[|2] = instance_position(x+100,y,obj_Umbrella);
umbId[|3] = instance_position(x-100,y,obj_Umbrella);
